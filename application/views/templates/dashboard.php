...
<link rel="shortcut icon" href="<?= base_url() ?>assets/css/favicon.ico">
    ...
    <title>Destia | Pos Indonesia</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3" style="font-family:Times ;">Destia</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Master Aset:</h6>
                        <a class="collapse-item" href="<?= base_url('satuan'); ?>">Satuan Aset</a>
                        <a class="collapse-item" href="<?= base_url('jenis'); ?>">Jenis Layanan</a>
                        <a class="collapse-item" href="<?= base_url('barang'); ?>">Data Aset</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('barangkeluar'); ?>">
                    ...
                    <span>Aset Dipinjam</span>
                </a>
            </li>

            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('barangkembali'); ?>">
                    <i class="fas fa-fw fa-check-circle"></i>
                    <span>Aset Kembali</span>
                </a>
            </li>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Destia 2020 &bull; by <?= anchor('', 'Muhamad Rizal Naufal Ghazi'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
