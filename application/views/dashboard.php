    ...
    <div class="col-xl-3 col-6 mb-4">
        <div class="card border-left-success shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Data Pemilik</div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Aset Yang Tersedia</div>
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="card shadow mb-4">
            <div class="card-header bg-success py-3">
                <h6 class="m-0 font-weight-bold text-white text-center">5 Transaksi Terakhir Aset Masuk</h6>
            </div>
            <div class="table-responsive">
    ...
    <div class="col-md-4">
        <div class="card shadow mb-4">
            <div class="card-header bg-warning py-3">
                <h6 class="m-0 font-weight-bold text-white text-center">5 Transaksi Terakhir Aset Dipinjam</h6>
            </div>
            <div class="table-responsive">
                <table class="table mb-0 table-sm table-striped text-center">
                    <thead>
                    ...
                    <tbody>
                        <?php foreach ($transaksi['barang_keluar'] as $tbk) : ?>
                            <tr>
                                ...
                                <td><span class="badge badge-warning"><?= $tbk['jumlah_keluar']; ?></span></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
    ...
    <div class="col-md-4">
        <div class="card shadow mb-4">
            <div class="card-header bg-danger py-3">
                <h6 class="m-0 font-weight-bold text-white text-center">5 Transaksi Terakhir Aset Rusak</h6>
            </div>
            <div class="table-responsive">
                <table class="table mb-0 table-sm table-striped text-center">
                    <thead>
                    ...
                    <tbody>
                        <?php foreach ($transaksi['barang_rusak'] as $tbr) : ?>
                            <tr>
                                <td><strong><?= $tbr['tanggal_rusak']; ?></strong></td>
                                <td><?= $tbr['nama_barang']; ?></td>
                                <td><span class="badge badge-danger"><?= $tbr['jumlah_rusak']; ?></span></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
